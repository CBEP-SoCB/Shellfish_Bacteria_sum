...
log of data, calculate means and medians, and back transform. We explore
 linear model approaches in another R Notebook.
...
Again, only the 1000 meter version shows significant patterns with land use. The
square root transform makes almost no difference regarding the adequacy of 
the fit.
