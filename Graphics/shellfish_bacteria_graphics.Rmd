...
Those confidence intervals look remarkably similar to the ones generated with
...
We can't use `emmeans()` here because of the high dimensionality of the model
space.  We calculate predictions directly.
